...
public:
    ...
    bool probe(uint64_t hash, double &alpha, double &beta, const int depth, double &ret_score, Move &tt_move);
    void store(uint64_t hash, const double score, const int depth, const TT_Flag flag, const Move &best_move);
